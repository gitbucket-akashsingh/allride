...
export const authLogoBoxClass =
  "w-20 h-20 rounded-3xl bg-zinc-100 dark:bg-black flex items-center justify-center shadow-2xl mb-5";

export const authDividerLineClass = "w-full border-t border-zinc-200 dark:border-white/10";

export const authGithubButtonClass =
  "flex items-center justify-center gap-3 py-4 rounded-2xl border border-zinc-200 bg-zinc-100 hover:bg-zinc-200 dark:border-white/10 dark:bg-zinc-900 dark:hover:bg-zinc-800 transition-all duration-300 font-semibold";
